...
* <a href="/tutorials/get_started_with_opal_using_docker">Try the getting started guide for containers</a>
...
- 🧠 "How-To"s
    ...
    - <a href="/tutorials/get_started_with_opal_using_docker">How to get started with OPAL (Container Images)</a>
    - <a href="/tutorials/trigger_data_updates">How to trigger Data Updates via OPAL</a>
