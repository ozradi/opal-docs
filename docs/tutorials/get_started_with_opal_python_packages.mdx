---
sidebar_position: 3
title: Get started with OPAL python packages
---
...
This HOW-TO focuses on setting-up OPAL with its packages and CLI interface, this guide is better to understand the main configurations of OPAL. There's also a separate guide for [setting-up OPAL from pre-built docker images](get-started-opal-docker-containers).
...
<a href="https://asciinema.org/a/XyDg1ot2Q6UOsWOkiSxGVSJmx?t=1" target="_blank"><img src="https://asciinema.org/a/XyDg1ot2Q6UOsWOkiSxGVSJmx.svg"/></a>
...
see [how to trigger data updates guide](../howto/trigger_data_updates)
CLI example:
