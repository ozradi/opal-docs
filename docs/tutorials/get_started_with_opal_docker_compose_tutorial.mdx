...
- **Policy-data real-time updates**
  ...
  - We have a guide for that: [how to trigger real-time data updates using OPAL](https://github.com/permitio/opal/blob/master/docs/howto/trigger_data_updates.md).
