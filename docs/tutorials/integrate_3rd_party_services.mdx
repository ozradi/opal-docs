...
To have the data from any data source, using [OPAL DataFetchers](https://github.com/permitio/opal/blob/master/docs/howto/write_your_own_fetch_provider.md) and OPA.
