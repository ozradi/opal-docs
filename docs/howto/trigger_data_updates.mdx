...
With the OPAL's vdata-update-triggers feature the billing-service, another service monitoring it, or even a person can trigger updates as they need - knowing OPAL will take it from there to all the points that need it.
...
<a href="https://asciinema.org/a/JYBzx1VrqJ17QnvmOnDYylOE6?t=1">
