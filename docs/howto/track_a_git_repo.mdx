...
Pass the secret as config when [running OPAL Server](/tutorials/get-started-opal-docker-containers#step-7-putting-it-all-together---running-the-server):
```sh
...
![](https://i.ibb.co/B28b9j1/webhooks1.png)
...
![](https://i.ibb.co/3CkRrq5/webhooks2.png)